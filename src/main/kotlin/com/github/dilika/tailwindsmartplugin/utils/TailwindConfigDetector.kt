 ...
 */
@Suppress("UNRESOLVED_REFERENCE", "UnresolvedExtensionProperty")
class TailwindConfigDetector(private val project: Project) {
    private val logger = Logger.getInstance(TailwindConfigDetector::class.java)
    ...
    private fun extractClassesWithNode(configFilePath: String?): List<String> {
        ...
        try {
            ...
            if (extractedClasses != null && extractedClasses.isNotEmpty()) {
